"""
Django settings for prim_39461 project.
...
WSGI_APPLICATION = 'prim_39461.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prim_39461 API",
    "DESCRIPTION": "API documentation for prim_39461 App",
    "VERSION": "v1",
}
